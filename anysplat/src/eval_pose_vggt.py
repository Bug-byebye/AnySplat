...
def setup_args():
    parser = argparse.ArgumentParser(
        description="CO3D pose eval: AnySplat baseline, VGGT, finetune; explicit per-sequence frame ids + optional unified pose postprocess."
    )
...
def _save_results(
    ...
    lines = [
        "CO3D pose evaluation (AnySplat baseline / VGGT / finetune)",
        "=" * 60,
